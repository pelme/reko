    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation_number', models.CharField(max_length=100, verbose_name='organisationsnummer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_option', models.CharField(choices=[('swish', 'Swish'), ('card', 'Kortbetalning'), ('cash', 'Kontant')], max_length=100)),
                ('producer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='producer.producer')),
            ],
        ),
    ]
