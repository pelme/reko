# Välkommen till handlareko.se!

En REKO-ring är ett sätt att sälja närproducerad mat helt utan mellanhänder. I
din lokala REKO-ring handlar du råvaror och produkter direkt från producenten. Se [Hushållningssällskapets information om REKO-ringar för mer info](https://hushallningssallskapet.se/tjanster/landsbygd/reko/).
...
## För dig som är admin för en REKO-ring

  * Lägg upp kommande utlämningar med tid/plats.
  * (Kommande) Ha en samlingssida för ringen med producenter som kommer till en viss utlämning.

**Vill du göra det möjligt för producenter i din ring att använda
handlareko.se? Hör av dig till oss
